...
public class ShieldFanVisual extends KineticBlockEntityVisual<ShieldBlockEntity> {
    ...
    public ShieldFanVisual(VisualizationContext context, ShieldBlockEntity blockEntity, float partialTick) {
